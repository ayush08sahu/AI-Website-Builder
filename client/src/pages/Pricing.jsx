...
function Pricing() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-[#050505] text-white px-x6 pt-16 pb-24">
        ...
        {plans.map((p, i) => (
          <motion.div
            ...
            className={`relative rounded-3xl p-8 border backdrop-blur-xl transition-all
                    ${
                      p.popular
                        ? "border-indigo-600 bg-gradient-to-b from-indigo-500/20 to-transparent shadow-2xl shadow-indigo-500/30"
