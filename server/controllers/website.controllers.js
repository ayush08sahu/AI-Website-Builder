...
export const generateWebsite = async (req, res) => {
  try {
    ...
    return res
      .status(500)
      .json({ message: `Error generating website: ${error.message}` });
  }
};
...
export const getWebsiteById = async (req, res) => {
  try {
    ...
    return res
      .status(500)
      .json({ message: `Error fetching website: ${error.message}` });
  }
};
...
export const changes = async (req, res) => {
  try {
    ...
    return res
      .status(500)
      .json({ message: `Error updating website: ${error.message}` });
  }
};
...
export const getAll = async (req, res) => {
  try {
    ...
    return res
      .status(500)
      .json({ message: `Error fetching websites: ${error.message}` });
  }
};
...
export const deploy = async (req,res) => {
  try {
    ...
    if(!website.slug){
      website.slug = website.title.toLowerCase().replace(/[^a-zA-Z0-9]/g, '').slice(0, 60)+website._id.toString().slice(-5);
    }
